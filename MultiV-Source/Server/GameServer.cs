...
namespace MultiVServer
{
    ...
    public class GameServer
    {
        public GameServer(ServerConfig conf)
        {
            ...
            NetPeerConfiguration config = new NetPeerConfiguration("MULTIV");
        ...
        private IEnumerable<Script> CompileScript(string script, string[] references, bool vbBasic = false)
        {
            ...
            compParams.ReferencedAssemblies.Add("MultiVServer.exe");
            compParams.ReferencedAssemblies.Add("MultiVShared.dll");
