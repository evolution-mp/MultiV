...
namespace MultiVMasterServer
{
    ...
    public static class VersioningUpdaterWorker
    {
        ...
        public static void GetVersion()
        {
            ...
            if (!File.Exists("updater" + Path.DirectorySeparatorChar + "version.txt") || !File.Exists("updater" + Path.DirectorySeparatorChar + "files.zip") || !File.Exists("updater" + Path.DirectorySeparatorChar + "MultiV.dll"))
            {
                Console.WriteLine("ERROR: version.txt, files.zip or MultiV.dll were not found.");
                return;
            }
            ...
            var subprocessVersionText =
                System.Diagnostics.FileVersionInfo.GetVersionInfo("updater" + Path.DirectorySeparatorChar +
                                                                  "MultiV.dll").FileVersion.ToString();
