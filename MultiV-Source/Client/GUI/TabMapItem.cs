...
namespace MultiV.GUI
{
    ...
    {
        public static string MAP_PATH = Main.MultiVInstallDir + "\\bin\\scripts\\map\\map.png";
        public static string BLIP_PATH = Main.MultiVInstallDir + "\\bin\\scripts\\map\\blips\\";
        ...
        public override void Draw()
        {
            ...
            else
            {
                ...
                //Ped PlayerChar = Game.Player.Character;
                /*Sprite.DrawTexture(BLIP_PATH + "player.png",
                    new Point((int)(newPos.X + World3DToMap2D(Game.Player.Character.Position).Width - 32 * playerScale),
                        (int)(newPos.Y + World3DToMap2D(Game.Player.Character.Position).Height - 32 * playerScale)),
                    new Size(32, 32));*/
        ...
        {
            var absoluteZero = new PointF(943 * Zoom, 1912 * Zoom);
