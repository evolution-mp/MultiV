...
namespace MultiV
{
    ...
    {
        public static GTA.Math.Quaternion ToQuaternion(this MultiVShared.Quaternion q)
        {
        ...
        public static MultiVShared.Vector3 ToLVector(this GTA.Math.Vector3 vec)
        {
            return new MultiVShared.Vector3()
            {
                X = vec.X,
                Y = vec.Y,
                Z = vec.Z,
        ...
        public static MultiVShared.Quaternion ToLQuaternion(this GTA.Math.Quaternion vec)
        {
            return new MultiVShared.Quaternion()
            {
                X = vec.X,
                Y = vec.Y,
                Z = vec.Z,
