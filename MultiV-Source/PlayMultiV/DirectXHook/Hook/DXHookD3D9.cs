...
using PlayMultiV.DirectXHook.Hook.Common;
using PlayMultiV.DirectXHook.Hook.DX9;
using PlayMultiV.DirectXHook.Interface;
using SharpDX.Direct3D9;

//using SlimDX.Direct3D9;

namespace PlayMultiV.DirectXHook.Hook
{
                ...
                if (this.Config.ShowOverlay)
                {
                    ...
                    if (_overlayEngine == null || _overlayEngine.Device.NativePointer != device.NativePointer)
                    {
                        ...
                        _overlayEngine.Overlays.Add(new Overlay
                        {
                            ...
                            {
                                // Add frame rate
                                new Common.FramesPerSecond(new System.Drawing.Font("Arial", 16, FontStyle.Bold)) { Location = new System.Drawing.Point(5,5), Color = System.Drawing.Color.Red, AntiAliased = true },
