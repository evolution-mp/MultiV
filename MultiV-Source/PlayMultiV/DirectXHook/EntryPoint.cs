    ...
    public class EntryPoint : EasyHook.IEntryPoint
    {
            ...
            CaptureConfig config)
        {
            ...
            _clientEventProxy.UpdateMainBitmap += newBitmap =>
            {
                ...
                {
                    var dHook = (DXHookD3D10_1)_directXHook;
                    //((ImageElement)dHook.OverlayEngine.Overlays[0].Elements[0]).Bitmap = newBitmap;
                }
            };
