...
namespace PlayMultiV.DirectXHook.Interface
{
    ...
    public class CaptureInterface : MarshalByRefObject
    {
        ...
        public event UpdateMainBitmap OnUpdateMainBitmap;
        ...
        private void SafeInvokeBitmapUpdate(Bitmap newBitmap)
        {
            ...
            UpdateMainBitmap listener = null;
            Delegate[] dels = OnUpdateMainBitmap.GetInvocationList();
    ...
    public class ClientCaptureInterfaceEventProxy : MarshalByRefObject
    {
        ...
        public event UpdateMainBitmap UpdateMainBitmap;
