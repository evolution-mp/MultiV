...
namespace GTA
{
	...
	public:
		...
		static void DrawTexture(System::String ^filename, int index, int level, int time, System::Drawing::PointF pos, System::Drawing::Size size);
		static void DrawTexture(System::String ^filename, int index, int level, int time, System::Drawing::PointF pos, System::Drawing::Size size, float rotation, System::Drawing::Color color);
		static void DrawTexture(System::String ^filename, int index, int level, int time, System::Drawing::PointF pos, System::Drawing::PointF center, System::Drawing::Size size, float rotation, System::Drawing::Color color);
		static void DrawTexture(System::String ^filename, int index, int level, int time, System::Drawing::PointF pos, System::Drawing::PointF center, System::Drawing::Size size, float rotation, System::Drawing::Color color, float aspectRatio);
