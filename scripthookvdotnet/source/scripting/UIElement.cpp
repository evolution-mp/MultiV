...
namespace GTA
{
	...
	UIText::UIText(String ^caption, Drawing::PointF position, float scale)
	{
		Enabled = true;
		Caption = caption;
		Position = position;
	...
	UIText::UIText(String ^caption, Drawing::PointF position, float scale, Drawing::Color color)
	{
		Enabled = true;
		Caption = caption;
		Position = position;
	...
	UIText::UIText(String ^caption, Drawing::PointF position, float scale, Drawing::Color color, GTA::Font font, bool centered)
	{
		Enabled = true;
		Caption = caption;
		Position = position;
	...
	UIText::UIText(String ^caption, Drawing::PointF position, float scale, Drawing::Color color, GTA::Font font, bool centered, bool shadow, bool outline)
	{
		Enabled = true;
		Caption = caption;
		Position = position;
	...
	UIRectangle::UIRectangle(Drawing::PointF position, Drawing::Size size)
	{
		Enabled = true;
		Position = position;
		Size = size;
	...
	UIRectangle::UIRectangle(Drawing::PointF position, Drawing::Size size, Drawing::Color color)
	{
		Enabled = true;
		Position = position;
		Size = size;
	...
	UIContainer::UIContainer(Drawing::PointF position, Drawing::Size size) : UIRectangle(position, size), _items(gcnew List<UIElement ^>())
	{
	}
	UIContainer::UIContainer(Drawing::PointF position, Drawing::Size size, Drawing::Color color) : UIRectangle(position, size, color), _items(gcnew List<UIElement ^>())
	{
	}
	...
	UISprite::UISprite(String ^textureDict, String ^textureName, Drawing::Size scale, Drawing::PointF position)
	{
		Enabled = true;
	...
	UISprite::UISprite(String ^textureDict, String ^textureName, Drawing::Size scale, Drawing::PointF position, Drawing::Color color)
	{
		Enabled = true;
		_textureDict = textureDict;
		_textureName = textureName;
	...
	UISprite::UISprite(String ^textureDict, String ^textureName, Drawing::Size scale, Drawing::PointF position, Drawing::Color color, float rotation)
	{
		Enabled = true;
		_textureDict = textureDict;
		_textureName = textureName;
